...
namespace Academy.HoloToolkit.Unity
{
    ...
    public class BasicCursor : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            this.gameObject.transform.position = GazeManager.Instance.HitPosition + GazeManager.Instance.HitNormal * DistanceFromCollision;

            // Reorient the cursor to match the hit object normal.
            this.gameObject.transform.up = GazeManager.Instance.HitNormal;
